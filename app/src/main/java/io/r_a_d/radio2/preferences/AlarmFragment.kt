...
class AlarmFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        fun updateDays(preference : MultiSelectListPreference?, newValue : Set<String>?)
        {
            ...
            val fullWeek = requireContext().resources.getStringArray(R.array.weekdays).toSet()
            val workingWeek = requireContext().resources.getStringArray(R.array.weekdays).toSet().minusElement("Saturday").minusElement("Sunday")
